...
export class TeacherService {
  ...
  createLesson(form: any) {
    return this.http.post(
      `${environment.endpoint}/teacher/lesson/create`,
      form
    );
  }
  updateLesson(form: any) {
    return this.http.post(
      `${environment.endpoint}/teacher/lesson/update`,
      form
    );
  }
  ...
  getLessonById(id: number) {
    return this.http.get(
      `${environment.endpoint}/teacher/lesson/show?lesson_id=${id}`
    );
  }
  getWeeklySchedule() {
  ...
  getBehaviorByClassId(course_id: number) {
    return this.http.get(
      `${environment.endpoint}/teacher/students/behaviors?course_id=${course_id}`
    );
  }

  createBehavior(form: any) {
    return this.http.post(
      `${environment.endpoint}/teacher/behavior/create`,
      form
    );
  }
  ...
  updateBehavior(form: any) {
    return this.http.post(
      `${environment.endpoint}/teacher/behavior/update`,
      form
    );
  }
  ...
  deleteBehavior(id: number) {
    return this.http.delete(
      `${environment.endpoint}/teacher/behavior/delete?behavior_id=${id}`
    );
  }

  setNegativeBehaviorAlert(class_id: any, count_limit: any) {
    return this.http.get(
      `${environment.endpoint}/teacher/behavior/set/alert-limit?class_id=${class_id}&negative_behaviors_count_limit=${count_limit}`
    );
  }
  ...
  addBehaviorToStudent(f: any) {
    ...
    return this.http.post(
      `${environment.endpoint}/teacher/behavior/student/create`,
      formData
    );
  }
  ...
  deleteBehaviorFromStudent(student_id: any, behavior_id: any, course_id: any) {
    return this.http.delete(
      `${environment.endpoint}/teacher/behavior/student/delete?student_id=${student_id}&behavior_id=${behavior_id}&course_id=${course_id}`
    );
  }
  ...
  showGradeDetailsbyClassId(id: any) {
    return this.http
      .get(`${environment.endpoint}/teacher/grade/show?course_id=${id}`)
      .pipe(
        map((data: any) => {
          return data;
        }),
  ...
  addDragetoClass(form: any) {
    return this.http.post(
      `${environment.endpoint}/teacher/grade/main-item/create`,
      form
    );
  }
  AddSubItem(form: any) {
    return this.http.post(
      `${environment.endpoint}/teacher/grade/sub-item/create`,
      form
    );
  }
  ...
  updateMianItem(form: any) {
    return this.http.post(
      `${environment.endpoint}/teacher/grade/main-and-sub-item/update`,
      form
    );
  }
  showMainItem(mainId: any, grade_id: any) {
    return this.http
      .get(
        `${environment.endpoint}/teacher/grade/main-item/show?grade_main_item_id=${mainId}&grade_id=${grade_id}`
      )
      .pipe(
        map((data: any) => {
          return data;
  ...
  deleteImageGrade(id: any) {
    return this.http.delete(
      `${environment.endpoint}/teacher/grade-image/delete?grade_id=${id}`
    );
  }
  deleteMainItem(id: any) {
    return this.http.delete(
      `${environment.endpoint}/teacher/grade/main-item/delete?grade_main_item_id=${id}`
    );
  }
  insertGradeforallStudent(form: any) {
    return this.http.post(
      `${environment.endpoint}/teacher/grades/students/create`,
      form
    );
  }
  insertGradeforStudent(form: any) {
    return this.http.post(
